...
public OnPlayerConnect(playerid)
{
    ...
    else if (SvHasMicro(playerid) == SV_FALSE)
    {
		...
		Dialog_Show(playerid, "DialogNotUsed", DIALOG_STYLE_MSGBOX, "Pesona "WHITE"- Mic Tidak Terdeteksi", lstring, "Quit", "");
...
public OnFilterScriptInit()
{
    ...
    print("-------------------- [Pesona Voice Chat System] --------------------\n\
    ===>> Berhasil dimuat dengan baik!\n\
    ===>> by: Angga Ali\n\
    ===>> dipersembahkan untuk Pesona\n\
    -------------------------------------------------------------------");
    return 1;
}
